...
@csrf_exempt
def GetRegisterOpenCustoms(request): 
    ...
    if request.method == 'GET':
        #customs/orders/getregisteropencustoms?picking=#&idempleado=#&
        #Look for params
        ...
        #Sp to exec
        sp = ''' SET NOCOUNT ON
             EXEC [web].[usp_regaperturaaduana] %s,%s'''

       #Try to execute
        try:
            response = exec_query(sp, (picking,idempleado,), database=database)
