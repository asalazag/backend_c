...
# from wmsAdapter.models import TdaWmsRelacionesSerialesChild
# from datetime import datetime, timedelta

# def read_seriales(request, db_name):
...
#         fields = [field.name for field in TdaWmsRelacionesSerialesChild._meta.get_fields()]
...
#             response = TdaWmsRelacionesSerialesChild.objects.using(db_name).filter(query, fecharegistro__range=[fecha_inicial, fecha_final]).order_by('-fecharegistro')[:500]
#             return response
