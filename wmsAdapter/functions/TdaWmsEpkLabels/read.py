...
from wmsAdapter.models import TdaWmsEpkLabels
from datetime import datetime, timedelta

def read_epk_labels(request, db_name):
        ...
        fields = [field.name for field in TdaWmsEpkLabels._meta.get_fields()]
        ...
        try:    
            ...
            response = TdaWmsEpkLabels.objects.using(db_name).filter(query, fecharegistro__range=[fecha_inicial, fecha_final]).order_by('-fecharegistro')[:500]
            return response
