...
@csrf_exempt
def GetInfoOrderCustomsConteiners(request): 
    ...
    if request.method == 'GET':
        #customs/orders/getinfoordercustomsconteiners?pedido=#&
        #Look for params
        ...
        #Sp to exec
        sp = ''' SET NOCOUNT ON
             EXEC [web].[usp_obtenerDsContenedoresAduanados_app_Pedido_Peso] %s'''
